...
import static TheElderMod.TheElderMod.characterPath;
import static TheElderMod.TheElderMod.makeID;

public class TheElder extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("ElderThing"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum(name = "NIGHT_BLACK") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "NIGHT_BLACK") @SuppressWarnings("unused")
